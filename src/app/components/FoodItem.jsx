export default function FoodItem({ name, image, price, description }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 flex flex-col items-center justify-between h-full w-[180px] max-w-xs transition-transform hover:scale-105 duration-200">
